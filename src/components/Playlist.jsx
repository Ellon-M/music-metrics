...
const Playlist = ({
  ...
  const details = {id, name, image, tracks};

  const imageStyle = {
    backgroundImage: `linear-gradient(
      rgba(163, 255, 168, 0.40), 
      rgba(253, 255, 253, 0.15)
    ),url(${image})`,
  }

  return (
    <li key={id} className="playlist">
      <div className="playlist-body" style={imageStyle} data-content={image}>
        ...
        <div className="playlist-bottom">
          <h4 className="playlist-name active">{name}</h4>
